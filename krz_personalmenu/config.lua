...
-- GENERAL --
Config.MenuTitle = 'Bearbeite DAS' -- change it to you're server name
Config.DoubleJob = false -- enable if you're using esx double job
Config.NoclipSpeed = 3.0 -- change it to change the speed in noclip
...
Config.Admin = {
	...
	},
	{
		...
		command = function()
			...
			if Player.noclip then
				...
				TriggerEvent("grv_notify", "red", "Adminstration", "Noclip wurde Aktiviert!")
			else
				...
				TriggerEvent("grv_notify", "red", "Adminstration", "Noclip wurde Deaktiviert!")
			end
	...
	},
	{
		...
		command = function()
			...
			if Player.godmode then
				SetEntityInvincible(plyPed, true)
				TriggerEvent("grv_notify", "red", "Adminstration", "Godmode wurde Aktiviert!")
			else
				SetEntityInvincible(plyPed, false)
				TriggerEvent("grv_notify", "red", "Adminstration", "Godmode wurde Deaktiviert!")
			end
		end
	},
	{
		...
		command = function()
			...
			if Player.ghostmode then
				SetEntityVisible(plyPed, false, false)
				TriggerEvent("grv_notify", "red", "Adminstration", "Ghostmode wurde Deaktiviert!")
			else
				SetEntityVisible(plyPed, true, false)
				TriggerEvent("grv_notify", "red", "Adminstration", "Ghostmode wurde Aktiviert!")
			end
		end
	},
	{
	...
	},
	{
		...
		command = function()
			...
			SetVehicleDirtLevel(plyVeh, 0.0)
                        TriggerEvent("grv_notify", "red", "Adminstration", "Das Fahrzeug wurde Adminstrativ Repariert!")
		end
	},
	{
		name = 'flipveh',
		...
		command = function()
			...
			TriggerEvent("grv_notify", "red", "Adminstration", "Das Fahrzeug wurde zurückgesetzt!")
		end
	},
	{
		name = 'givemoney',
		...
		command = function()
			...
			if DoesBlipExist(waypointHandle) then
				Citizen.CreateThread(function()
					...
					TriggerEvent("grv_notify", "red", "Adminstration", "Du hast dich zum Wegpunkt teleportiert!")
				end)
			else
				TriggerEvent("grv_notify", "red", "Adminstration", "Es wurde kein Wegpunkt gefunden!")
			end
		end
	},
	{
		...
		command = function()
			...
			TriggerEvent('skinchanger:loadSkin', {
				...
				glasses_2    = 0,
                        ...
                        TriggerEvent("grv_notify", "red", "Adminstration", "Du hast nun das Projektleitungs Outfit an!")
		end
	},
	{
		name = 'mw4',
		label = 'Manager',
		groups = {'_dev', 'admin', 'superadmin'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
			...
			TriggerEvent('skinchanger:loadSkin', {
				...
				glasses_2    = 0,
                     ...
                     TriggerEvent("grv_notify", "red", "Adminstration", "Du hast dein Manager Outfit angezogen!")
		end
	},
...

	{
		name = 'mw2',
		label = 'Admin',
		groups = {'_dev', 'admin', 'superadmin', 'mod'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
			...
			TriggerEvent('skinchanger:loadSkin', {
				...
				glasses_2    = 0,
                          ...
                          TriggerEvent("grv_notify", "red", "Adminstration", "Du hast dein Admin Anzug angezogen!")
		end
	},
		...
		command = function()
			...
			TriggerEvent('skinchanger:loadSkin', {
				...
				glasses_2    = 0,
                        ...
                        TriggerEvent("grv_notify", "red", "Adminstration", "Du hast dein Moderator Outfit angezogen!")
		end
	},
	{
		name = 'changeskin',
	...
	},
	{
		name = 'changeskin4',
		label = 'Supporter',
		groups = {'_dev', 'owner', 'superadmin', 'mod'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
