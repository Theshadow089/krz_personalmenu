Locales['en'] = {
	...
	['admin_noclipon'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~NoClip ~g~ Aktiviert',
        ['admin_noclipoff'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~NoClip ~r~ Deaktiviert',
        ['admin_godmodeon'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Godmode ~g~ Aktiviert',
        ['admin_godmodeoff'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Godmode ~r~ Deaktiviert',
        ['admin_ghoston'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Unsichtbarkeit ~g~ Aktiviert',
        ['admin_ghostoff'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Unsichtbarkeit ~r~ Deaktiviert',
        ['admin_vehicleflip'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Fahrzeug umgedreht!',
        ['admin_tpmarker'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Du hast dich Teleportiert!',
        ['admin_nomarker'] = '~r~[Cataleya Adminsystem]~ns~--------------------~ns~Kein Wegpunkt gesetzt!',
